...
public class Rook extends Piece {
  ...
  public Rook(Position position, PieceType pieceType, PieceColor pieceColor, boolean hasMoved) {
  ...
  public ArrayList<Move> generateMoves(Piece[][] board) {
    ...
    int[] fileIncrement = {1, -1, 0, 0};
    int[] rankIncrement = {0, 0, 1, -1};
  ...
  public Rook deepCopy() {
    return new Rook(this.getPosition(), this.getPieceType(), this.getPieceColor(), this.isHasMoved());
  }
}
